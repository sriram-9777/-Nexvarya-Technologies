...
import { Sparkles, Store, Users, Cpu, Shield, Award, Phone, MapPin, Mail, ArrowRight } from 'lucide-react';
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 space-y-14 min-h-screen">
      ...
      <div className="text-center max-w-3xl mx-auto space-y-4">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-950/90 border border-emerald-700/50 text-amber-400 text-xs font-bold shadow-sm">
          ...
          <span>Enterprise Platform Identity</span>
        </div>
        <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tight leading-tight font-serif">
          About Nexvarya Technologies
        </h1>
        <p className="text-sm sm:text-base text-slate-300 leading-relaxed max-w-2xl mx-auto">
          Empowering merchants, service providers, wholesale buyers, and local customers across Rajahmundry and Andhra Pradesh through robust multi-tenant software architecture.
        </p>
      </div>
      ...
      <div className="bg-slate-900/90 border border-emerald-900/40 rounded-3xl p-8 sm:p-12 shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-10 items-center backdrop-blur-md">
        <div className="space-y-6">
          ...
          <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            <strong className="text-amber-400">Nexvarya Technologies</strong> was established to bridge the gap between neighborhood offline businesses and modern digital commerce. Our scalable directory platform enables local shop owners to manage products, offer quantity-based bulk discounts, print store counter QR posters, and take direct orders on WhatsApp without steep commissions.
          </p>
        ...
        <div className="bg-gradient-to-br from-emerald-950 via-slate-900 to-amber-950 text-white p-8 rounded-3xl space-y-6 shadow-2xl border border-emerald-800/40 relative overflow-hidden">
          ...
          <h3 className="text-lg font-black flex items-center gap-2 text-amber-400 font-serif">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <strong className="block text-white">Mobile / WhatsApp Support</strong>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900/90 border border-emerald-900/40 hover:border-emerald-500/60 p-7 rounded-3xl space-y-3 shadow-2xl transition-all backdrop-blur-md">
          ...
          <h3 className="font-extrabold text-white text-base font-serif">Multi-Tenancy for Businesses</h3>
          <p className="text-xs text-slate-300 leading-relaxed">
            One platform hosting hundreds of local shop owners—from Grocery, Restaurants, Medical Stores, to Electronics and Handyman services.
          </p>
        </div>
        ...
        <div className="bg-slate-900/90 border border-emerald-900/40 hover:border-emerald-500/60 p-7 rounded-3xl space-y-3 shadow-2xl transition-all backdrop-blur-md">
          ...
          <h3 className="font-extrabold text-white text-base font-serif">Bulk Pricing Discount Engine</h3>
          <p className="text-xs text-slate-300 leading-relaxed">
            Automated pricing calculations supporting units (KG, Liter, Unit, Meter, Box, Service) with tier-based fixed or percentage discounts.
          </p>
        </div>
        ...
        <div className="bg-slate-900/90 border border-emerald-900/40 hover:border-emerald-500/60 p-7 rounded-3xl space-y-3 shadow-2xl transition-all backdrop-blur-md">
          ...
          <h3 className="font-extrabold text-white text-base font-serif">Native Multi-Language Support</h3>
          <p className="text-xs text-slate-300 leading-relaxed">
            Built from the ground up with a flexible translation framework supporting English 🇬🇧 and Telugu 🇮🇳 seamlessly.
          </p>
        </div>
