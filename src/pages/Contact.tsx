  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10 min-h-screen">
      ...
      <div className="text-center max-w-xl mx-auto space-y-3">
        <span className="inline-block px-3.5 py-1 rounded-full text-[10px] font-bold tracking-widest uppercase bg-emerald-950/90 text-amber-400 border border-emerald-700/50 shadow-sm">
          Get in Touch
        </span>
        <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight font-serif">{t('contact')}</h1>
        <p className="text-xs text-slate-400">
          Have questions or want to list your business on the Nexvarya Platform? Get in touch with our team.
        </p>
      </div>
        ...
        <div className="bg-slate-900/90 border border-emerald-900/40 p-6 sm:p-8 rounded-3xl space-y-6 flex flex-col justify-between shadow-2xl backdrop-blur-md">
          <div className="space-y-6">
            <div>
              ...
              <h3 className="text-xl font-bold text-white font-serif">Platform Onboarding & Support</h3>
            </div>
            ...
            <div className="space-y-4 text-xs text-slate-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="block text-white">Company Headquarters</strong>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="block text-white">Direct Phone / WhatsApp Support</strong>
          ...
          <div className="pt-4 border-t border-slate-800/80 text-xs text-slate-400 flex items-center gap-1.5 font-medium">
            ...
            <span>24/7 Support for registered shop partners</span>
          </div>
        </div>
        ...
        <div className="bg-slate-900/90 border border-emerald-900/40 p-6 sm:p-8 rounded-3xl shadow-2xl backdrop-blur-md">
          {submitted ? (
            <div className="py-12 text-center space-y-3">
              ...
              <h3 className="text-lg font-bold text-white font-serif">Message Sent Successfully!</h3>
              <p className="text-xs text-slate-400">
                Thank you for reaching out. A representative from Nexvarya Technologies will contact you shortly.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-slate-300">Message / Inquiry</label>
                <textarea
                  required
                  rows={4}
                  value={msg}
