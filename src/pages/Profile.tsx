...
export const Profile: React.FC = () => {
  ...
  if (!currentUser) {
    return (
      <div className="max-w-md mx-auto my-16 text-center p-8 bg-white rounded-3xl shadow-xl border border-slate-200">
        ...
        <p className="text-xs text-slate-500 mb-4">You need to log in to view and edit your profile.</p>
        <button
  ...
  const getRoleBadge = () => {
    switch (currentUser.role) {
      case 'admin':
        return <span className="px-3.5 py-1 rounded-full bg-purple-950/90 text-purple-300 text-xs font-bold border border-purple-700/60 flex items-center gap-1.5 shadow-sm"><Shield className="w-3.5 h-3.5 text-purple-400" /> Administrator</span>;
      case 'shop_owner':
        return <span className="px-3.5 py-1 rounded-full bg-amber-950/90 text-amber-300 text-xs font-bold border border-amber-700/60 flex items-center gap-1.5 shadow-sm"><Store className="w-3.5 h-3.5 text-amber-400" /> Shop Owner</span>;
      default:
        return <span className="px-3.5 py-1 rounded-full bg-emerald-950/90 text-emerald-300 text-xs font-bold border border-emerald-700/60 flex items-center gap-1.5 shadow-sm"><User className="w-3.5 h-3.5 text-emerald-400" /> Customer</span>;
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-8 min-h-screen">
      ...
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-emerald-950 via-slate-900 to-amber-950 rounded-3xl p-6 sm:p-8 text-white shadow-2xl border border-emerald-800/40 flex flex-col sm:flex-row items-center gap-6 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-500/5 rounded-full blur-3xl pointer-events-none" />
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-800 border border-emerald-400/40 flex items-center justify-center text-2xl font-black text-amber-300 uppercase shadow-lg shrink-0 font-serif">
        ...
        <div className="text-center sm:text-left space-y-2 flex-1 relative z-10">
          <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3">
            <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-white font-serif">{currentUser.name}</h1>
            {getRoleBadge()}
          </div>
      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-slate-900/90 border border-emerald-900/40 p-6 sm:p-8 rounded-3xl shadow-2xl space-y-5 backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">Preferred Platform Language</label>
              <div className="relative">
                <select
                  value={prefLang}
            ...
            <div className="space-y-1 sm:col-span-2">
              <label className="text-xs font-semibold text-slate-300">Door No / Street Address *</label>
              <div className="relative">
                <input
                  type="text"
                  required
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">Village / Town / City *</label>
              <input
                type="text"
                required
            ...
            <div className="space-y-1">
              <label className="text-xs font-semibold text-slate-300">Postal Pincode *</label>
              <input
                type="text"
                required
                value={pincode}
        ...
        {currentUser.role === 'shop_owner' && (
          <div className="bg-slate-900/90 border border-emerald-900/40 p-6 sm:p-8 rounded-3xl shadow-2xl space-y-5 backdrop-blur-md">
            <h2 className="text-xs font-bold text-amber-400 uppercase tracking-wider border-b border-emerald-900/50 pb-3 flex items-center gap-2">
              ...
              <span>2. Shop & Business Details</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1 sm:col-span-2">
                <label className="text-xs font-semibold text-slate-300">Shop Business Address *</label>
                <input
                  type="text"
                  required
                  value={shopAddress}
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-slate-300">Closing Time</label>
                <div className="relative">
                  <input
                    type="text"
                    value={closingTime}
              ...
              <div className="space-y-1">
                <label className="text-xs font-semibold text-slate-300">Direct WhatsApp Order Number</label>
                <input
                  type="tel"
              ...
              <div className="space-y-1 sm:col-span-2">
                <label className="text-xs font-semibold text-slate-300">Shop Description</label>
                <textarea
                  value={description}
